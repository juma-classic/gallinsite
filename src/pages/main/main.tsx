...
const SpeedBotIcon = () => (
    <svg fill='var(--text-general)' width='20px' height='20px' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
        <path d='M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Zm3.36-11.75a1,1,0,0,0-1.41.09l-2.2,2.21-.84-.84a1,1,0,0,0-1.41,1.41l1.25,1.25a1,1,0,0,0,1.41,0l2.61-2.6a1,1,0,0,0,.09-1.42Z' />
    </svg>
);
                                                ...
                                                >
                                                    <div
                                                        style={{
                                                            ...
                                                            borderRadius: '50%',
                                                            background:
                                                                'linear-gradient(135deg, #00ffb8 0%, #00c3ff 100%)',
                                                            display: 'flex',
                                                            alignItems: 'center',
                                                            justifyContent: 'center',
                                                            marginBottom: '0.8rem',
                                                    ...
                                                    >
                                                        <span
                                                            style={{
                                                                ...
                                                                fontFamily:
                                                                    'Orbitron, Exo, Roboto Mono, Arial, sans-serif',
